...
void Matrix::SetEntry(int position, float value)
{
	if(position>=0 && position<=15)
		entries[position]=value;
}
	
float Matrix::GetEntry(int position) const
{
	if(position>=0 && position<=15)
...
VECTOR4D Matrix::GetRow(int position) const
{
	if(position==0)
...
VECTOR4D Matrix::GetColumn(int position) const
{
	if(position==0)
...
Matrix Matrix::operator+(const Matrix & rhs) const		//overloaded operators
{
	return Matrix(	entries[0]+rhs.entries[0],
...
Matrix Matrix::operator*(const Matrix & rhs) const
{
	...
	{
		return Matrix(	entries[0]*rhs.entries[0]+entries[4]*rhs.entries[1]+entries[8]*rhs.entries[2],
	...
	if(	entries[3]==0.0f && entries[7]==0.0f && entries[11]==0.0f && entries[15]==1.0f)
	{
		return Matrix(	entries[0]*rhs.entries[0]+entries[4]*rhs.entries[1]+entries[8]*rhs.entries[2]+entries[12]*rhs.entries[3],
...
Matrix operator*(float scaleFactor, const Matrix & rhs)
{
...
VECTOR4D Matrix::operator*(const VECTOR4D rhs) const
{
...
VECTOR3D Matrix::GetRotatedVector3D(const VECTOR3D & rhs) const
{
...
VECTOR3D Matrix::GetInverseRotatedVector3D(const VECTOR3D & rhs) const
{
	//rotate by transpose:
...
VECTOR3D Matrix::GetTranslatedVector3D(const VECTOR3D & rhs) const
{
	return VECTOR3D(rhs.x+entries[12], rhs.y+entries[13], rhs.z+entries[14]);
}

VECTOR3D Matrix::GetInverseTranslatedVector3D(const VECTOR3D & rhs) const
{
	return VECTOR3D(rhs.x-entries[12], rhs.y-entries[13], rhs.z-entries[14]);
}
...
{
	Matrix result=GetInverseTranspose();
...
{
	return Matrix(	entries[ 0], entries[ 4], entries[ 8], entries[12],
...
void Matrix::InvertTranspose(void)
{
	*this=GetInverseTranspose();
}

Matrix Matrix::GetInverseTranspose(void) const
{
	Matrix result;
...
void Matrix::AffineInvert(void)
{
	(*this)=GetAffineInverse();
}

Matrix Matrix::GetAffineInverse(void) const
{
...
void Matrix::AffineInvertTranspose(void)
{
	(*this)=GetAffineInverseTranspose();
}

Matrix Matrix::GetAffineInverseTranspose(void) const
{
	//return the transpose of the rotation part
	//and the negative of the inverse rotated translation part
	//transposed
...
void Matrix::SetTranslation(const VECTOR3D & translation)
{
	LoadIdentity();
...
void Matrix::SetScale(const VECTOR3D & scaleFactor)
{
	LoadIdentity();
...
void Matrix::SetRotationAxis(const double angle, const VECTOR3D & axis)
{
...
void Matrix::SetRotationEuler(const double angleX, const double angleY, const double angleZ)
{
	LoadIdentity();
...
void Matrix::SetPerspective(	float left, float right, float bottom,
...
void Matrix::SetPerspective(float fovy, float aspect, float n, float f)
{
...
void Matrix::SetOrtho(	float left, float right, float bottom,
							float top, float n, float f)
{
	LoadIdentity();
...
void Matrix::SetTranslationPart(const VECTOR3D & translation)
{
...
void Matrix::SetRotationPartEuler(const double angleX, const double angleY, const double angleZ)
{
